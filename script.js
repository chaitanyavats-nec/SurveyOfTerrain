...
const nodes = [
    ...
    { id: "truthiness", label: "Truthiness", tooltip: "Weighing facts and emotion", info: "Built through repetition and emotion.", x: 1100, y: 300, className: "node yellow" },
    { id: "viewer", label: "Viewer", tooltip: "Receives and interprets content.", info: "Based on their sense of truthiness, the viewer can either put a stop to disinformation, or be.", x: 1300, y: 200, className: "node blue" },
    ...
    { id: "intent", label: "Intent", tooltip: "Underlying purpose or motivation.", info: "Can be malicious, political, or financial.", x: 400, y: 450, className: "node yellow" },
    { id: "newsChannels", label: "News Channels", tooltip: "TV, online news platforms.", info: "Jaffrelot and Verniers (2020) write: “Republic TV, Times Now and Zee TV, among many other channels, regularly spread pieces of (dis)information that echoed to a large extent the social media handled by the BJP IT Cell", x: 500, y: 400, className: "node blue" },
    { id: "socialMedia", label: "Social Media Platforms", tooltip: "Facebook, Twitter, etc.", info: "Facilitate rapid and wide dissemination.", x: 500, y: 450, className: "node blue" },
    { id: "immediateAssociates", label: "immediateAssociates", tooltip: "Friends, family, colleagues.", info: "Personal networks influence belief.Viewers are less likely to challenge information if it comes from their elders or family members", x: 500, y: 500, className: "node blue" },
